...
export const MCP_ACTION_LOG_BODY_LIMIT = "64kb";
export const DEFAULT_MCP_ACTION_LOG_RATE_LIMIT = 600;
export const DEFAULT_MCP_ACTION_LOG_RATE_LIMIT_WINDOW_MS = 60_000;
...
export function authenticateMcpActionLogSecret(
  req: Request,
  res: Response,
  next: NextFunction,
) {
